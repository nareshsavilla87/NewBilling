(function(module) {
  mifosX.controllers = _.extend(module, {
    ViewClientController: function(scope,webStorage, routeParams , route, location, resourceFactory,paginatorService, http,$modal,dateFilter,API_VERSION,$rootScope,PermissionService,TENANT) {
    	 scope.client = [];
         scope.error = {};
