(function(module) {
	mifosX.controllers = _.extend(module, {
		CreateChargeCodeController : function(scope, resourceFactory, location,
			...
			resourceFactory.chargecodetemplateResource
					.getAllchargecode(function(data) {
			...
			scope.submit = function() {
				...
				resourceFactory.chargecodeResource
						.save(this.formData,
								function(data) {
									location.path('/viewchargecode/'
											+ data.resourceId);
								});
			};
		}
	...
	mifosX.ng.application.controller(
			'CreateChargeCodeController',
			[ '$scope', 'ResourceFactory', '$location', '$rootScope',
					mifosX.controllers.CreateChargeCodeController ]).run(
			function($log) {
